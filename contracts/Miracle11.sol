...
contract Miracle11 is ERC721, ERC721URIStorage, Ownable {
    ...
    function safeMint(
        ...
        uint256 articleId = _articleIdCounter.current(); //getting current count
        _articleIdCounter.increment(); //incrementing after use
    ...
    function tipWriter(uint256 _id) public payable {
        require(_id > 0 && _id <= _articleIdCounter.current());
        //get the article
